  ...
  return (
     <div className="max-w-sm p-4 shrink-0 h-[350px] rounded-lg bg-radial-[at_50%_75%] from-sky-200 via-blue-400 to-indigo-900 to-90% text-white shadow-lg">
            <div className="flex justify-between items-start">
                <span className="bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded-md">High</span>
                <span className="text-sm">{data.tasks[1].taskDate}</span>
            </div>
            <h2 className="mt-4 text-lg font-bold">{data.tasks[1].taskTitle}</h2>
